    ...
    if request.POST :
        ...
        if u:
            ...
            if up:
                ...
                return HttpResponseRedirect("/cornell/add_profile/")
...
def profile(request):
    ...
    if request.method == 'GET':
        ...
        return HttpResponseRedirect("/cornell/profile/#close")
    ...
    if request.method == 'GET':
        ...
        if u.is_authenticated() and cu == u:
            ...
            if ouId != None:
                ...
                return HttpResponseRedirect("/cornell/no_user/")
            try:
                group = ou.groups.get()
            except Group.DoesNotExist:
                group = None
            ...
            print ' redirecting to '+ '/cornell/user_login/?next='+request.path+'?ou='+ouId
            return HttpResponseRedirect('/cornell/user_login/?next='+request.path+'?ou='+ouId)
        ...
        if request.POST.get('leave_group'):
            ...
            if group:
                ...
                if group.user_set.all().count():
                    ...
                    print 'group deleted'
                context_dict['group'] = group
            return HttpResponseRedirect('/cornell/accept_invite/'+str(id)+'/?ou='+str(ouId))
